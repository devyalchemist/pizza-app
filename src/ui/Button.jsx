...
export default function Button({ children, onClick, type, disabled, to }) {
  const base =
  ...
  const styles = {
    ...
    secondary:
      ' inline-block rounded-full text-sm border-2 divide-stone-300  font-semibold uppercase tracking-wide text-stone-500 transition-colors duration-300 hover:bg-stone-300 hover:text-stone-800 focus:text-stone-800 focus:bg-yellow-300 focus:outline-none focus:ring focus:ring-stone-200 focus:ring-offset-2 active:bg-slate-400 disabled:cursor-not-allowed px-4 py-2.5 md:px-6 md:py-3.5',
  };
